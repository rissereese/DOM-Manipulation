...
const opinionArticle = document.querySelectorAll("article.opinion");
const recipeArticle = document.querySelectorAll("article.recipe");
const updateArticle = document.querySelectorAll("article.update");
...
function addNewArticle() {
    ...
    var inputHeader = document.getElementById("inputHeader").value;
    var articleType = document.querySelector("input[name='articleType']:checked").id;
    var inputArticle = document.getElementById("inputArticle").value;
